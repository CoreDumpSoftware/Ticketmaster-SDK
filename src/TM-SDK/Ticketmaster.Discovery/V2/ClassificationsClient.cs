namespace Ticketmaster.Discovery.V2
{
    ...
    public class ClassificationsClient : BaseClient, IClassificationsClient
    {
        ...
        {
            return ExecuteRequestAsync(RequestHelper.CreateGetRequest(request, ClassificationsGenresPathWithId), request);
        }
        ...
        public Task<IRestResponse> CallGetSegmentDetails(GetRequest request)
        {
            return ExecuteRequestAsync(RequestHelper.CreateGetRequest(request, ClassificationsSegmentDetailsPathWithId), request);
        }

        public Task<IRestResponse> CallGetSubSegmentDetails(GetRequest request)
        {
            return ExecuteRequestAsync(
              RequestHelper.CreateGetRequest(request, ClassificationsSubGenresPathWithId),
              request);
